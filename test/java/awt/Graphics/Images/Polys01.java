...
/*
 * @test
 * @summary Paints a couple of animated polygons using a cached graphics object.
...
public class Polys01 extends TestCase {
    ...
    class AnimatedWindow extends Frame {
        volatile Graphics cachedGraphics = null;
        ...
        public AnimatedWindow( Rectangle rect ) throws Exception {
            ...
            cachedGraphics = AnimatedWindow.this.getGraphics();
        ...
        public void animateOnce() {
            cachedGraphics.setColor(Color.cyan);
            cachedGraphics.fillRect(0, 0, rect.width, rect.height);
            for (ActivePolygon item : polys) {
                item.move();
                item.render(cachedGraphics);
            }           
        }
    ...
    public static Test suite() {
        return new TestSuite( Polys01.class);
    }
