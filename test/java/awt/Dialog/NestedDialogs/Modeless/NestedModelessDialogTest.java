...
// From the modal dialog it launches a modeless dialog with a text field in it and tries
// to write into the text field. The test succeeds if you are successfully able to write 
// into this Nested Modeless Dialog
/////////////////////////////////////////////////////////////////////////////////////
...
public class NestedModelessDialogTest extends TestCase {

    public static Test suite() {
        return new TestSuite(NestedModelessDialogTest.class);
    }
    ...
    public void testModelessDialogs() throws Exception  {
        ...
        try {
            // Thread.currentThread().setName("NestedModelessDialogTest Thread");
            // launch first frame with fistButton
            frame = new StartFrame();
            VisibilityValidator.setVisibleAndConfirm(frame);
            
            Thread.sleep(250); // shouldn't need this, but Thread.sleep adds stability
            ...
            Thread.sleep(250); // shouldn't need this, but Thread.sleep adds stability
            assertTrue( "TestFrame actionPerformed() never called, see <rdar://problem/3429130>", event_checkpoint[0].isValid() );
            ...
            assertTrue( "IntermediateDialog actionPerformed() never called, see <rdar://problem/3429130>", event_checkpoint[1].isValid() );
            ...
            // But that's why I put in the Thread.sleep
            Thread.sleep(250); // shouldn't need this, but Thread.sleep adds stability
            try { EventQueue.invokeAndWait(new Runnable() { public void run() {} }); } catch (Exception e) {}
            ...
            Thread.sleep(250); // shouldn't need this, but Thread.sleep adds stability
            RobotUtilities.clickAt(txtDiag, 14,10); // Click Close box of modeless dialog with textField
