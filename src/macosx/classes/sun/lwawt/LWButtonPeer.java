...
class LWButtonPeer
    extends LWComponentPeer<Button, LWButtonPeer.JButtonDelegate>
    implements ButtonPeer, ActionListener
{
    ...
    @Override
    protected JButtonDelegate createDelegate() {
        JButtonDelegate delegate = new JButtonDelegate();
