...
- (id) initWithFont:(NSFont *)font isFakeItalic:(BOOL)isFakeItalic {
    ...
    if (self) {
        ...
        fFont = [font retain];
        fNativeCGFont = CTS_GetCGFontForNSFont(fFont);
        if (fNativeCGFont != NULL) {
            CGFontRetain(fNativeCGFont);
        }
    }
    return self;
}
...
#pragma mark --- apple.awt.CGraphicsEnvironment JNI ---

/*
 * Class:     apple_awt_CGraphicsEnvironment
 * Method:    loadNativeFonts
 * Signature: ()V
 */
JNIEXPORT void JNICALL
Java_apple_awt_CGraphicsEnvironment_loadNativeFonts
    (JNIEnv *env, jobject jthis)
{
    static JNF_CLASS_CACHE(jc_CGraphicsEnvironment,
                           "apple/awt/CGraphicsEnvironment");
    static JNF_MEMBER_CACHE(jm_registerFont, jc_CGraphicsEnvironment,
                            "registerFont",
...
/*
 * Class:     Java_apple_awt_CGraphicsEnvironment_loadNativeDirFonts
 * Method:    loadNativeDirFonts
 * Signature: (Ljava/lang/String;)V;
 */
JNIEXPORT void JNICALL
Java_apple_awt_CGraphicsEnvironment_loadNativeDirFonts
...
#pragma mark --- sun.font.FontManager JNI ---
...
Java_sun_font_FontManager_loadFileFont
